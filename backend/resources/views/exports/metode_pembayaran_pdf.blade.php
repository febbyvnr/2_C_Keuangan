...
<div class="header">
    ...
    <h3>LAPORAN METODE PEMBAYARAN</h3>
    <p>Daftar Referensi Metode Pembayaran</p>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width: 90%;">Deskripsi Metode Pembayaran</th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-left">
                {{ $row->DESKRIPSI_METODE_PEMBAYARAN ?? '-' }}
            </td>
        </tr>

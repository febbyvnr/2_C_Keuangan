...
class PenerimaanExport implements FromArray, WithEvents
{
    protected $data;
    protected $periode;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $ttdJabatanRow = $saldoRow + 2;
                $ttdNamaRow = $saldoRow + 3;
                $spasi1Row = $saldoRow + 4;
                $spasi2Row = $saldoRow + 5;
                $spasi3Row = $saldoRow + 6;
                $ttdGarisRow = $saldoRow + 7;
                $ttdNipRow = $saldoRow + 8;
                $tanggalRow = $saldoRow + 9;
